...
local TheDrox = io.open("TheDrox", 'w')
TheDrox:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
sudo lua5.3 Drox.lua
done
]])
TheDrox:close()
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheDrox -X kill
screen -S TheDrox ./TheDrox
done
]])
Run:close()
...
os.execute('chmod +x TheDrox;chmod +x Run;./Run')
end
...
TheDrox = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheDrox)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheDrox,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,1214622341}  
...
DevelopersQ = Redis:sismember(TheDrox.."Drox:DevelopersQ:Groups",UserId) 
TheBasicsQ = Redis:sismember(TheDrox.."Drox:TheBasicsQ:Group"..ChatId,UserId) 
TheBasics = Redis:sismember(TheDrox.."Drox:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheDrox.."Drox:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheDrox.."Drox:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheDrox.."Drox:Addictive:Group"..ChatId,UserId)
...
Status = 'المطور'
elseif DevelopersQ then
Status = Redis:get(TheDrox.."Drox:Developer:Bot:Reply"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = "المالك"
elseif TheBasics then
Status = Redis:get(TheDrox.."Drox:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheDrox.."Drox:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheDrox.."Drox:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheDrox.."Drox:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الكروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheDrox.."Drox:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheDrox.."Drox:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheDrox.."Drox:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheDrox.."Drox:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheDrox.."Drox:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheDrox.."Drox:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheDrox.."Drox:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheDrox.."Drox:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheDrox.."Drox:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheDrox.."Drox:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheDrox.."Drox:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheDrox.."Drox:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheDrox.."Drox:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheDrox.."Drox:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheDrox.."Drox:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheDrox.."Drox:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheDrox.."Drox:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheDrox.."Drox:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheDrox.."Drox:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheDrox.."Drox:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheDrox.."Drox:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheDrox.."Drox:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheDrox.."Drox:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheDrox.."Drox:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheDrox.."Drox:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheDrox.."Drox:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheDrox.."Drox:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheDrox.."Drox:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheDrox.."Drox:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheDrox.."Drox:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheDrox.."Drox:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheDrox.."Drox:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheDrox.."Drox:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheDrox).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheDrox..'Drox:Channel:Join')
if Channel then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(TheDrox.."Lock:channell"..msg_chat_id) then
print(Redis:get(TheDrox.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(TheDrox.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(TheDrox..'Drox:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(TheDrox) then
...
elseif Redis:sismember(TheDrox.."Drox:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheDrox.."Drox:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheDrox.."Drox:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheDrox.."Drox:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = "المالك"
elseif Redis:sismember(TheDrox.."Drox:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheDrox.."Drox:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheDrox.."Drox:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheDrox.."Drox:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheDrox.."Drox:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheDrox.."Drox:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheDrox.."Drox:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheDrox.."Drox:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheDrox.."Drox:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheDrox.."Drox:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheDrox) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheDrox.."Drox:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheDrox.."Drox:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheDrox.."Drox:Status:Welcome"..msg_chat_id) then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheDrox) then
return false
end
local floods = Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheDrox.."Drox:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheDrox.."Drox:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheDrox.."Drox:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheDrox.."Drox:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(TheDrox..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TheDrox..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
sens = 400  
if Redis:get(TheDrox.."Drox:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheDrox.."Drox:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheDrox.."Drox:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheDrox.."Drox:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheDrox.."Drox:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Originators then -- التوجيه
local Fwd_Group = Redis:get(TheDrox.."Drox:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheDrox.."Drox:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheDrox.."Drox:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheDrox.."Drox:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheDrox.."Drox:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheDrox.."Drox:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheDrox.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheDrox.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheDrox.."Lock:Bot:kick"..msg_chat_id)
...
Redis:set(TheDrox.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(TheDrox.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(TheDrox..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(TheDrox.."Drox:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheDrox.."Drox:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheDrox.."Drox:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheDrox.."Drox:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheDrox.."Drox:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheDrox.."Drox:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheDrox.."Drox:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheDrox.."Drox:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheDrox.."Drox:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheDrox.."Drox:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheDrox.."Drox:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheDrox.."Drox:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheDrox.."Drox:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheDrox.."Drox:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheDrox.."Drox:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheDrox.."Drox:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheDrox..'Drox:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheDrox.."Drox:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheDrox.."Drox:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheDrox.."Drox:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheDrox.."Drox:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheDrox.."Drox:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheDrox.."Drox:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheDrox.."Drox:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheDrox.."Drox:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheDrox..'Drox:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheDrox..'Drox:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheDrox.."Drox:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheDrox.."Drox:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheDrox.."Drox:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheDrox..'Drox:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheDrox..'Drox:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheDrox.."Drox:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheDrox.."Drox:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheDrox.."Drox:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheDrox.."Drox:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheDrox.."Drox:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheDrox.."Drox:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheDrox.."Drox:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheDrox.."Drox:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheDrox..'Drox:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheDrox.."Drox:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheDrox.."Drox:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
...
if text == "الغاء" then 
Redis:del(TheDrox.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheDrox.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheDrox.."Drox:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheDrox.."Drox:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheDrox.."Drox:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheDrox.."Drox:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheDrox.."Drox:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheDrox.."Drox:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheDrox.."Drox:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheDrox.."Drox:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheDrox.."Drox:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheDrox.."Drox:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
if text and text:match("^(.*)$") then
if Redis:get(TheDrox.."Drox:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
local veico = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheDrox.."Drox:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheDrox..'Drox:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheDrox..'Drox:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheDrox.."Drox:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheDrox.."Drox:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheDrox.."Drox:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheDrox.."Drox:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheDrox..'Drox:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheDrox.."Drox:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheDrox.."Drox:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheDrox.."Drox:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheDrox.."Drox:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheDrox.."Drox:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheDrox.."Drox:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheDrox.."Drox:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheDrox.."Drox:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheDrox.."Drox:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(TheDrox..'Drox:'..v..text)
end
Redis:del(TheDrox.."Drox:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheDrox.."Drox:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheDrox.."Drox:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheDrox.."Drox:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheDrox.."Drox:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheDrox.."Drox:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheDrox.."Drox:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheDrox.."Drox:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheDrox.."Drox:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheDrox.."Drox:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheDrox.."Drox:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheDrox.."Drox:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheDrox.."Drox:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheDrox.."Drox:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheDrox.."Drox:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(TheDrox.."Drox:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(TheDrox..'Drox:GetTexting:DevTheDrox'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TheDrox..'Drox:GetTexting:DevTheDrox'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم الغاء حفظ كليشة المطور')
end
Redis:set(TheDrox..'Drox:Texting:DevTheDrox',text)
Redis:del(TheDrox..'Drox:GetTexting:DevTheDrox'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم حفظ كليشة المطور')
end
if Redis:get(TheDrox.."Drox:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n‹ : تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheDrox.."Drox:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheDrox.."Drox:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheDrox.."Drox:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheDrox.."Drox:Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - سمايل او سمايلات","md",true)
end
end 
if Redis:get(TheDrox.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TheDrox.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TheDrox.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheDrox.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(TheDrox.."Game:enkliz"..msg.chat_id) then
if text == Redis:get(TheDrox.."Game:enkliz"..msg.chat_id) then
Redis:incrby(TheDrox.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheDrox.."Game:enkliz"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : العب مره اخره وارسل - انجليزي","md",true)  
end
end
if Redis:get(TheDrox.."Drox:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheDrox.."Drox:Game:Monotonous"..msg.chat_id) then
Redis:del(TheDrox.."Drox:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  
end
end 
if Redis:get(TheDrox.."Drox:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheDrox.."Drox:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheDrox.."Drox:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - حزوره","md",true)  
end
end
if Redis:get(TheDrox.."Drox:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheDrox.."Drox:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheDrox.."Drox:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - معاني","md",true)   
end
end
if Redis:get(TheDrox.."Drox:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheDrox.."Drox:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheDrox.."Drox:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : لقد فزت في اللعبه \n‹ : اللعب مره اخره وارسل - العكس","md",true)  
end
end
if Redis:get(TheDrox.."Drox:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheDrox.."Drox:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheDrox.."Drox:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheDrox.."Drox:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheDrox.."Drox:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheDrox.."Drox:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheDrox.."Drox:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheDrox.."Drox:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheDrox.."Drox:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheDrox.."Drox:Game:Difference"..msg.chat_id) then 
Redis:del(TheDrox.."Drox:Game:Difference"..msg.chat_id)
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheDrox.."Drox:Game:Example"..msg.chat_id) then
if text == Redis:get(TheDrox.."Drox:Game:Example"..msg.chat_id) then 
Redis:del(TheDrox.."Drox:Game:Example"..msg.chat_id)
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if tonumber(TheDrox) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheDrox..'Drox:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheDrox.."Drox:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheDrox.."Drox:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheDrox.."Drox:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheDrox.."Drox:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheDrox.."Drox:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheDrox.."Drox:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheDrox) then 
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheDrox.."Drox:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheDrox.."Drox:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheDrox.."Drox:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheDrox.."Drox:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
...
if (Redis:get(TheDrox..'Drox:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(TheDrox..'Drox:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheDrox).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n‹ : البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheDrox..'Drox:Channel:Join',ChannelUser) 
Redis:set(TheDrox..'Drox:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(TheDrox..'Drox:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheDrox..'Drox:Channel:Join')
...
local President = Redis:smembers(TheDrox.."Drox:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheDrox.."Drox:Originators:Group"..v)
local Manager = Redis:smembers(TheDrox.."Drox:Managers:Group"..v)
local Admin = Redis:smembers(TheDrox.."Drox:Addictive:Group"..v)
local Vips = Redis:smembers(TheDrox.."Drox:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheDrox.."Drox:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheDrox.."Drox:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheDrox.."Drox:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheDrox.."Drox:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheDrox.."Drox:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
{
{text = Jabwa, url = 'https://t.me/P222P'}, 
},
{
{text = Grosupsw, url = 'https://t.me/DroxTeAm'}, 
},
{
{text = Usperos, url = 'https://t.me/DroxTeAm'}, 
},
}
...
local NumAdd = Redis:get(TheDrox.."Drox:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
...
if Redis:sismember(TheDrox.."Drox:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheDrox..'Drox:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔ : عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheDrox..'Drox:Num:Add:Bot'),"md",true)  
end
...
if UserInfo.first_name ~= "" then
Redis:sadd(TheDrox.."Drox:TheBasicsQ:Group"..msg_chat_id,v.member_id.user_id) 
end
end
end
Redis:sadd(TheDrox.."Drox:TheBasicsQ:Group"..msg_chat_id,msg.sender.user_id) 
Redis:sadd(TheDrox.."Drox:ChekBotAdd",msg_chat_id)
Redis:set(TheDrox.."Drox:Status:Id"..msg_chat_id,true) ;Redis:set(TheDrox.."Drox:Status:Reply"..msg_chat_id,true) ;Redis:set(TheDrox.."Drox:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheDrox.."Drox:Status:BanId"..msg_chat_id,true) ;Redis:set(TheDrox.."Drox:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheDrox.."Drox:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheDrox.."Drox:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheDrox.."Drox:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheDrox.."Drox:ChekBotAdd",msg_chat_id) then
...
Redis:set(TheDrox.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TheDrox.."lockalllll"..msg_chat_id,"on")
...
if Redis:get(TheDrox.."lockalllll"..msg_chat_id) == "on" then
if not msg.Addictive then
...
Redis:del(TheDrox..'Abs:gif:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المتحركه'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:gif:Abs'..msg.chat_id,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ✯") and not Redis:get(TheDrox..'Abs:gif:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheDrox..'Abs:memz:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الميمز'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:memz:Abs'..msg.chat_id,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ✯") and not Redis:get(TheDrox..'Abs:memz:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheDrox..'Abs:Remix:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الريمكس'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:Remix:Abs'..msg.chat_id,true)  
end
...
local F333F = ' \n‹ : تم تفعيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheDrox..'Abs:Photo:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الصوره'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:Photo:Abs'..msg.chat_id,true)  
end
if text and (text == "صوره" or text == "↫ صوره ✯") and not Redis:get(TheDrox..'Abs:Photo:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheDrox..'Abs:Anime:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الانمي'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:Anime:Abs'..msg.chat_id,true)  
end
if text and (text == "انمي" or text == "↫ انمي ✯") and not Redis:get(TheDrox..'Abs:Anime:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheDrox..'Abs:Movies:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل الافلام'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:Movies:Abs'..msg.chat_id,true)  
end
if text and (text == "فلم" or text == "↫ فلم ✯") and not Redis:get(TheDrox..'Abs:Movies:Abs'..msg.chat_id) then
...
local F333F = ' \n‹ : تم تفعيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:del(TheDrox..'Abs:Series:Abs'..msg.chat_id) 
end
...
local F333F = ' \n‹ : تم تعطيل المسلسلات'
LuaTele.sendText(msg_chat_id,msg_id,F333F,"md")
Redis:set(TheDrox..'Abs:Series:Abs'..msg.chat_id,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ✯") and not Redis:get(TheDrox..'Abs:Series:Abs'..msg.chat_id) then
...
if text == 'بايو' and not Redis:get(TheDrox..'idnotmembio'..msg.chat_id)  then
...
if Redis:get(TheDrox..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تعطيل امر البايو مسبقا\n ✓',"md")
else
Redis:set(TheDrox.."idnotmembio"..msg.chat_id,"true")
...
if not Redis:get(TheDrox..'idnotmembio'..msg.chat_id)  then
LuaTele.sendText(msg_chat_id,msg_id, '‹ : تم تفعيل امر البايو مسبقا\n ✓',"md")
else
Redis:del(TheDrox.."idnotmembio"..msg.chat_id)
...
if Redis:get(TheDrox..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id) == "sendlove" then
...
Redis:del(TheDrox..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id)
end
if Redis:get(TheDrox..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الغباء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheDrox..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id)
end
if Redis:get(TheDrox..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id) == "sendlove" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الذكاء  : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheDrox..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id)
end
if text and Redis:get(TheDrox..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id) == "sendkrhe" then
num = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnum = num[math.random(#num)]
local tttttt = '⌯ اليك النتائج الخـاصة :\n\n⌯ نسبه الكرة : *'..text..'* '..sendnum..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheDrox..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id)
end
if text and text ~="نسبه الرجوله" and Redis:get(TheDrox..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id) == "sendrjoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","😁 98","🥰 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبة الرجوله لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheDrox..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id)
end
if text and text ~="نسبه الانوثه" and Redis:get(TheDrox..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id) == "sendanoe" then
numj = {"😂 10","🤤 20","😢 30","😔 35","😒 75","🤩 34","😗 66","🤐 82","😪 23","😫 19","😛 55","😜 80","😲 63","😓 32","🙂 27","😎 89","😋 99","?? 98","😀 79","🤣 100","😣 8","🙄 3","😕 6","🤯 0",};
sendnuj = numj[math.random(#numj)]
local tttttt = '‹ : اليك النتائج الخـاصة :\n\n‹ : نسبه الانوثة لـ : *'..text..'* '..sendnuj..'%'
LuaTele.sendText(msg_chat_id,msg_id,tttttt) 
Redis:del(TheDrox..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id)
end

if text == "نسبه الحب" or text == "نسبه حب" and msg.reply_to_message_id ~= 0 then
if not Redis:get(TheDrox.."AlNsb"..msg.chat_id) then    
Redis:set(TheDrox..":"..msg.sender.user_id..":lov_Bots"..msg.chat_id,"sendlove")
...
if not Redis:get(TheDrox.."AlNsb"..msg.chat_id) then    
Redis:set(TheDrox..":"..msg.sender.user_id..":lov_Bottts"..msg.chat_id,"sendlove")
...
if not Redis:get(TheDrox.."AlNsb"..msg.chat_id) then    
Redis:set(TheDrox..":"..msg.sender.user_id..":lov_Botttuus"..msg.chat_id,"sendlove")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheDrox.."AlNsb"..msg.chat_id) then    
Redis:set(TheDrox..":"..msg.sender.user_id..":krh_Bots"..msg.chat_id,"sendkrhe")
hggg = '‹ : الان ارسل اسمك واسم الشخص الثاني :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheDrox.."AlNsb"..msg.chat_id) then    
Redis:set(TheDrox..":"..msg.sender.user_id..":rjo_Bots"..msg.chat_id,"sendrjoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if not Redis:get(TheDrox.."AlNsb"..msg.chat_id) then    
Redis:set(TheDrox..":"..msg.sender.user_id..":ano_Bots"..msg.chat_id,"sendanoe")
hggg = '‹ : الان ارسل اسم الشخص :'
LuaTele.sendText(msg_chat_id,msg_id,hggg) 
return false
end
...
if Redis:get(TheDrox..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تعطيل صورتي مسبقا\n ✓',"md")
else
Redis:set(TheDrox.."myphoto"..msg.chat_id,"off")
...
if not Redis:get(TheDrox..'myphoto'..msg.chat_id)  then
return LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم تفعيل صورتي مسبقا\n ✓',"md")
else
Redis:del(TheDrox.."myphoto"..msg.chat_id)
...
Redis:del(TheDrox.."mybuti"..msg_chat_id)
...
Redis:set(TheDrox.."mybuti"..msg_chat_id,"off")
...
Redis:del(TheDrox.."sayy"..msg_chat_id)
...
Redis:set(TheDrox.."sayy"..msg_chat_id,"off")
LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : تم امر امر كول * ',"md",true)  
end
if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(TheDrox.."mybuti"..msg_chat_id) == "off" then
...
if Redis:get(TheDrox.."sayy"..msg_chat_id) == "off" then
...
if text == "صورتي" then
if Redis:get(TheDrox.."myphoto"..msg_chat_id) == "off" then
...
local TotalMsg = Redis:get(TheDrox..'Drox:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheDrox..'Drox:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheDrox.."Drox:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {
'صورتك فدشي خيالي',
"شتحس مخلي هلصورا ؟ ",
"محتحت اقسم",
...
Get_Is_Id = Redis:get(TheDrox.."Drox:Set:Id:Group"..msg_chat_id)
if Redis:get(TheDrox.."Drox:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
local TotalMsg = Redis:get(TheDrox..'Drox:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheDrox..'Drox:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheDrox..'Drox:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheDrox..'Drox:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*‹ : ايديه : '..UserId..
'\n‹ : معرفه : @'..UserName..
...
{{text =news,url = "https://t.me/DroxTeAm"}, },}}
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheDrox..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
...
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheDrox).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheDrox.."Drox:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Developers:Groups",Message_Reply.sender.user_id) 
...
Redis:srem(TheDrox.."Drox:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : الحمار هاذا بطل يصفن ").Reply,"md",true)  
else
Redis:srem(TheDrox.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "قرد" then
if not Redis:sismember(TheDrox.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if TextMsg == "ملك" then
if not Redis:sismember(TheDrox.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : يارب تعقل وتبقا ذكي 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheDrox.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : اعقل بقا 😂   🙃 ").Reply,"md",true)  
else
Redis:srem(TheDrox.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheDrox.."Drox:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Developers:Groups",UserId) 
...
Redis:srem(TheDrox.."Drox:TheBasicsW:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheDrox.."Drox:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheDrox.."Drox:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheDrox.."Drox:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheDrox.."Drox:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"‹ : تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if not msg.Originators and not Redis:get(TheDrox.."Drox:Status:SetId"..msg_chat_id) then
...
Redis:sadd(TheDrox.."Drox:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."wtka:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."mar:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."2rd:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."klb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."smb:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."kholat:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."8by:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."3ra:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheDrox.."Drox:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
...
local Info_Members = Redis:smembers(TheDrox.."Drox:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."wtka:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."mar:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."2rd:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."klb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."smb:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."kholat:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."8by:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheDrox.."3ra:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheDrox.."Drox:Status:Games"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تفعيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:set(TheDrox.."Drox:Status:KickMe"..msg_chat_id,true) 
...
if text and text:match("^(.*)$") then
if Redis:get(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
...
if text and text:match("^(.*)$") then
if Redis:get(TheDrox.."Drox1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheDrox..'Drox1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheDrox..'Drox1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
...
local list = Redis:smembers(TheDrox.."Drox1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheDrox.."Drox1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheDrox.."Drox1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
...
if Redis:get(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(TheDrox.."Drox1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(TheDrox.."Drox1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheDrox.."Drox1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then
local Text = Redis:get(TheDrox.."Drox1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheDrox.."Drox1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheDrox.."Drox1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
Redis:del(TheDrox.."Drox11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheDrox.."Drox11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheDrox.."Drox11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheDrox.."Drox11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheDrox.."Drox11:Add:Rd:Sudo:Text1"..v) 
...
Redis:set(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
if Redis:get(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(TheDrox.."Drox11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = Redis:get(TheDrox.."Drox11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheDrox.."Drox11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then
local Text = Redis:get(TheDrox.."Drox11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheDrox.."Drox11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheDrox.."Drox11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
local list = Redis:smembers(TheDrox.."Drox:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheDrox.."Drox:allM"..msg.chat_id)  
...
local httpsCurl = "http://185.185.127.158/Drox/tahaj200.php?token="..Token.."&msg="..MsgId.."&Text="..URL.escape(Ttext).."&chat_id="..msg.chat_id.."&user="..msg.sender.user_id
...
local UserId_Info = LuaTele.searchPublicChat("@DroxTeAm")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(TheDrox..msg_chat_id.."mutlqat:")
...
local Text =[[
Welcome To Source
‹ : [𝖲𝗈𝗎𝗋𝖼𝖾 𝖣𝖱𝗈𝗑](https://t.me/DroxTeAm) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Source Channel ›', url = "https://t.me/DroxTeAm"}},{{text = '‹ Developer', url = "https://t.me/P222P"},{text = 'Tws 𝖣𝖱𝗈𝗑 ›', url = "https://t.me/Yv4bot"}},{{text = '‹ تـفآصيل. ›', url = "https://t.me/BB4BBB"}}}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/DroxTeAm&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Redis:del(TheDrox.."Drox:Status:joinet"..msg_chat_id) 
...
Redis:set(TheDrox.."Drox:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الترحيب' then
Redis:del(TheDrox.."Drox:Status:Welcome"..msg_chat_id) 
...
if TextMsg == 'الالعاب' then
Redis:del(TheDrox.."Drox:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(TheDrox.."Drox:Status:KickMe"..msg_chat_id) 
...
if Redis:sismember(TheDrox.."Drox:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheDrox.."Drox:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheDrox.."Drox:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheDrox.."Drox:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheDrox.."Drox:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheDrox.."Drox:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheDrox.."Drox:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if not Redis:sismember(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:sismember(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"‹ : تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheDrox.."Drox:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheDrox.."Drox:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text and Redis:get(TheDrox.."addchannel"..msg.sender.user_id) == "on" then
Redis:set(TheDrox.."chadmin"..msg_chat_id,text) 
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حفظ ايدي القناه","md",true)  
Redis:del(TheDrox.."addchannel"..msg.sender.user_id)
end
if text == "القناه المضافه" then
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheDrox.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص『 '..Controller_Num(7)..' 』* ',"md",true)  
end
Redis:set(TheDrox.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheDrox..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(TheDrox.."Lock:channell"..msg_chat_id,true) 
...
Redis:del(TheDrox.."Lock:channell"..msg_chat_id)  
...
Redis:set(TheDrox..'Drox:'..lock..msg_chat_id,"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheDrox..'Drox:'..lock..msg_chat_id)    
end
...
Redis:set(TheDrox.."Drox:Lock:phshar"..msg_chat_id,true) 
...
Redis:set(TheDrox..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TheDrox.."Drox:Lock:phshar"..msg_chat_id)  
...
Redis:del(TheDrox..'lock:Fars'..msg.chat_id) 
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheDrox.."Drox:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheDrox.."Drox:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheDrox.."Drox:Filter:Group:"..v..msg_chat_id)   
...
if Redis:get(TheDrox.."Drox:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheDrox.."Drox:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TheDrox.."Drox:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheDrox.."Drox:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheDrox.."Drox:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheDrox.."Drox:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheDrox.."Drox:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheDrox.."Drox:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheDrox.."Drox:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheDrox.."Drox:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheDrox.."Drox:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheDrox.."Drox:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheDrox.."Drox:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheDrox.."Drox:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheDrox..'Drox:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheDrox..'Drox:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheDrox..'Drox:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'‹ : تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد رسائلك هنا *~ '..(Redis:get(TheDrox..'Drox:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد التعديلات هنا *~ '..(Redis:get(TheDrox..'Drox:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'‹ : عدد جهاتك المضافه هنا *~ '..(Redis:get(TheDrox.."Drox:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:del(TheDrox.."Drox:DevelopersQ:Groups") 
...
Redis:del(TheDrox.."Drox:Developers:Groups") 
...
Redis:del(TheDrox.."Drox:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheDrox.."Drox:Originators:Group"..msg_chat_id) 
...
Redis:del(TheDrox.."Drox:Managers:Group"..msg_chat_id) 
...
Redis:del(TheDrox.."Drox:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheDrox.."Drox:BanAll:Groups") 
...
Redis:del(TheDrox.."Drox:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheDrox.."Drox:SilentGroup:Group"..msg_chat_id) 
...
for k,v in pairs(list) do
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheDrox.."Drox:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheDrox.."Drox:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheDrox.."Drox:Add:Rd:Manager:video_note"..v..msg_chat_id)
...
for k,v in pairs(list) do
if Redis:get(TheDrox.."Drox:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ‹ : "
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
for k,v in pairs(list) do
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:vico"..v)   
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:Text"..v)   
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:Photo"..v)
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:Video"..v)
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:File"..v)
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:Audio"..v)
Redis:del(TheDrox.."Drox:Add:Rd:Sudo:video_note"..v)
Redis:del(TheDrox.."Drox:List:Rd:Sudo")
end
...
db = "ملصق 🃏"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Sudo:File"..v) then
db = "ملف ‹ : "
elseif Redis:get(TheDrox.."Drox:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheDrox.."Drox:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/DroxTeAm'}, 
},
{
...
x = x + 1
Redis:srem(TheDrox..'Drox:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheDrox)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*‹ : البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheDrox..'Drox:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheDrox..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheDrox..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheDrox..'Drox:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Drox..'zwgnyy'..msg.chat_id,true)
...
Redis:del(Drox..'zwgnyy'..msg.chat_id)
send(msg_chat_id,msg_id,'\n ‹ : تم تفعيل امر جوزني')
end
if text == "جوزني" or text == "زوجني" then
if not Redis:get(Drox..'zwgnyy'..msg.chat_id) then 
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
if tonumber(member_id) == tonumber(msg.sender.user_id) or tonumber(member_id) == tonumber(Drox) or LuaTele.getUser(member_id).type.luatele == "userTypeBot" then 
return LuaTele.sendText(msg_chat_id,msg_id,"*‹ : ماعدنه احد خلصن شوفلك كلبه احسلك*","md")
end
local reply_markup = LuaTele.replyMarkup{
  type = 'inline',
  data = {
...
return LuaTele.sendText(msg_chat_id,msg_id,"‹ : جـبتلك عاروسهةة "..mem_tag.." اي رايك فيها ؟؟","md",false, false, false, false, reply_markup)
end
end
if text == "تتجوزيني" and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if tonumber(Redis:get(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(Drox) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الحيحانه","md")
elseif Redis:get(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:") then
local zwg_id =  Redis:get(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
...
elseif Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:") then
  local zwg_id =  Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")
  local zwg_info = LuaTele.getUser(zwg_id)
  return LuaTele.sendText(msg_chat_id,msg_id,"هناديلك مراتك\n["..zwg_info.first_name.."](tg://user?id="..zwg_id..")\nالحقي يا وليه جوزك عاوز يتجوز عليكي","md")
elseif not Redis:get(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")  then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
if text == "زوجتي" then
  if Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    local zwga_id = Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")
  ...
  elseif not Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:") then
...
elseif tonumber(Message_Reply.sender.user_id) == tonumber(Drox) then
  return LuaTele.sendText(msg_chat_id,msg_id,"ابعد عني يبن الحيحانه","md")
elseif tonumber(Redis:get(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) ~= tonumber(msg.sender.user_id) or tonumber(Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")) ~= tonumber(Message_Reply.sender.user_id) then
  return LuaTele.sendText(msg_chat_id,msg_id,"مش مراتك عشان تطلقها يهبل","md")
elseif tonumber(Redis:get(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")) == tonumber(msg.sender.user_id) or tonumber(Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")) == tonumber(Message_Reply.sender.user_id) then
    Redis:del(Drox..msg_chat_id..Message_Reply.sender.user_id.."mtzwga:")
    Redis:del(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")
...
if text == "بوت طلقني" then
  if not Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:") then 
  ...
  elseif Redis:get(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:") then
    ...
    Redis:del(Drox..msg_chat_id..msg.sender.user_id.."mtzwga:")
    Redis:del(Drox..msg_chat_id..zwg_id.."mtzwga:")
...
Redis:del(Drox.."smsme"..msg.chat_id)
...
Redis:set(Drox.."smsme"..msg.chat_id,true)
send(msg.chat_id,msg.id,"‹ : تم تعطيل سمسمي")
end
if not Redis:get(Drox.."smsme"..msg.chat_id) then
if text and msg.reply_to_message_id ~= 0 then
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Message_Reply and Message_Reply.sender and tonumber(Message_Reply.sender.user_id) == tonumber(Drox) then
...
if text == "زواج" or text == "رفع زوجتي" or text == "رفع زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if tonumber(Message_Reply.sender.user_id) == tonumber(Drox) then
    return send(msg_chat_id,msg_id,"ابعد عني يحيحان ملكقتش غيري","md",true)  
  end
  if Redis:sismember(Drox..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    local rd_mtzwga = {
      "اسف يصحبي متجوزه",
    ...
    if Redis:sismember(Drox..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
    Redis:srem(Drox..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
    end
    Redis:sadd(Drox..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if text == "تاك للزوجات" or text == "الزوجات" then
  local zwgat_list = Redis:smembers(Drox..msg_chat_id.."zwgat:")
...
if text == "طلاق" or text == "تنزيل زوجتي" or text == "تزيل زوجي" and msg.reply_to_message_id ~= 0 then
  ...
  if Redis:sismember(Drox..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
    Redis:srem(Drox..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
    Redis:sadd(Drox..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
    local rd_tmtlaq = {
      "تم طلاقكم للاسف",
...
if text == "تاك للمطلقات" or text == "المطلقات" then
  local mutlqat_list = Redis:smembers(Drox..msg_chat_id.."mutlqat:")
  if #mutlqat_list == 0 then 
...
local bank_users = Redis:smembers(TheDrox.."zrfffidtf")
...
local mony = Redis:get(TheDrox.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(TheDrox..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(TheDrox.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(TheDrox.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDrox.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(TheDrox.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDrox.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheDrox..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(TheDrox..':toob:Name:'..zwga_id)
fnte = Redis:get(TheDrox..':toob:Name:'..v[2])
...
if tonumber(Message_Reply.sender.user_id) == tonumber(TheDrox) then
return LuaTele.sendText(msg.chat_id,msg.id, "• غبي تبي تتزوج بوت!\n","md",true)
end
if Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(TheDrox..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(TheDrox..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(TheDrox..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(TheDrox..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(TheDrox..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(TheDrox..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(TheDrox..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(TheDrox.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(TheDrox.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(TheDrox.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(TheDrox.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheDrox..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(TheDrox..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(TheDrox..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." دولار ","md")
end
if Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(TheDrox..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(TheDrox..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(TheDrox..':toob:Name:'..zoog2)
...
if Redis:sismember(TheDrox.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(TheDrox.."noolb"..yemsg.sender.user_id)
gg = Redis:get(TheDrox.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(TheDrox.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(TheDrox.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(TheDrox.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(TheDrox.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(TheDrox.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(TheDrox.."mznom"..msg_chat_id..zwga_id)
Redis:srem(TheDrox.."almtzog"..msg_chat_id,zwga_id)
Redis:del(TheDrox.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(TheDrox.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(TheDrox..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(TheDrox..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(TheDrox..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(TheDrox..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(TheDrox..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." دولار","md")
end
if text == "طلاق"  then
if not Redis:get(TheDrox..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(TheDrox.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
gg = "والت كارد ."
flossst = Redis:get(TheDrox.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(TheDrox.."nonna"..msg.sender.user_id,news)
Redis:set(TheDrox.."noolb"..msg.sender.user_id,creditcc)
Redis:set(TheDrox.."nnonb"..msg.sender.user_id,text)
Redis:set(TheDrox.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheDrox.."nonallname"..creditcc,news)
Redis:set(TheDrox.."nonallbalc"..creditcc,balas)
Redis:set(TheDrox.."nonallcc"..creditcc,creditcc)
Redis:set(TheDrox.."nonallban"..creditcc,text)
...
local banid = msg.sender.user_id
Redis:set(TheDrox.."nonna"..msg.sender.user_id,news)
Redis:set(TheDrox.."noolb"..msg.sender.user_id,creditvi)
Redis:set(TheDrox.."nnonb"..msg.sender.user_id,text)
Redis:set(TheDrox.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheDrox.."nonallname"..creditvi,news)
Redis:set(TheDrox.."nonallbalc"..creditvi,balas)
Redis:set(TheDrox.."nonallcc"..creditvi,creditvi)
Redis:set(TheDrox.."nonallban"..creditvi,text)
...
local banid = msg.sender.user_id
Redis:set(TheDrox.."nonna"..msg.sender.user_id,news)
Redis:set(TheDrox.."noolb"..msg.sender.user_id,creditex)
Redis:set(TheDrox.."nnonb"..msg.sender.user_id,text)
Redis:set(TheDrox.."nnonbn"..msg.sender.user_id,gg)
Redis:set(TheDrox.."nonallname"..creditex,news)
Redis:set(TheDrox.."nonallbalc"..creditex,balas)
Redis:set(TheDrox.."nonallcc"..creditex,creditex)
Redis:set(TheDrox.."nonallban"..creditex,text)
...
if Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
Redis:srem(TheDrox.."noooybgy", msg.sender.user_id)
Redis:del(TheDrox.."noolb"..msg.sender.user_id)
Redis:del(TheDrox.."zrffdcf"..msg.sender.user_id)
Redis:srem(TheDrox.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(TheDrox.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(TheDrox.."nool:flotysb"..v)
Redis:del(TheDrox.."zrffdcf"..v)
Redis:del(TheDrox.."innoo"..v)
Redis:del(TheDrox.."nnooooo"..v)
Redis:del(TheDrox.."nnoooo"..v)
Redis:del(TheDrox.."nnooo"..v)
Redis:del(TheDrox.."nnoo"..v)
Redis:del(TheDrox.."polic"..v)
Redis:del(TheDrox.."ashmvm"..v)
Redis:del(TheDrox.."hrame"..v)
Redis:del(TheDrox.."test:mmtlkat6"..v)
Redis:del(TheDrox.."zahbmm2"..v)
end
Redis:del(TheDrox.."ttpppi")
...
ballanceed = Redis:get(TheDrox.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(TheDrox.."noolb"..msg.sender.user_id)
gg = Redis:get(TheDrox.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheDrox.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(TheDrox.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(TheDrox.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." دولار 💸 )\n• الزرف ( "..pppp.." دولار ?? )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(TheDrox.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(TheDrox.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(TheDrox.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(TheDrox.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(TheDrox.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(TheDrox.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheDrox.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(TheDrox.."ttpppi",msg.sender.user_id)
Redis:setex(TheDrox.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(TheDrox.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(TheDrox.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(TheDrox.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(TheDrox.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(TheDrox.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(TheDrox.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(TheDrox.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(TheDrox.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('TheDrox:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('TheDrox:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('TheDrox:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('TheDrox:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(TheDrox.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(TheDrox.."transn"..msg.sender.user_id,coniss)
Redis:setex(TheDrox.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(TheDrox.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(TheDrox.."noolb"..msg.sender.user_id)
gg = Redis:get(TheDrox.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(TheDrox.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(TheDrox.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(TheDrox.."transn" .. msg.sender.user_id)
...
if Redis:get(TheDrox.."nonallcc"..text) then
local UserNamey = Redis:get(TheDrox.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(TheDrox.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(TheDrox.."nnonb"..fsvhhh)
nouu = Redis:get(TheDrox.."nnonbn"..fsvhhh)
...
if Redis:get(TheDrox.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(TheDrox.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(TheDrox.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(TheDrox.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(TheDrox.."polici" .. msg.sender.user_id,600, true)
Redis:setex(TheDrox.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(TheDrox.."nool:flotysb"..bl) or 0
Redis:decrby(TheDrox.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
if Redis:get(TheDrox.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:setex(TheDrox.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
if Redis:get(TheDrox.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(TheDrox.."xxxr" .. msg.sender.user_id) then
Redis:incrby(TheDrox.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(TheDrox.."ttpppi",msg.sender.user_id)
...
Redis:sadd(TheDrox.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." دولار 💸","md",true)
Redis:setex(TheDrox.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(TheDrox.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(TheDrox.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." دولار 💸","md",true)
else
...
if Redis:get(TheDrox.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(TheDrox.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(TheDrox.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(TheDrox.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(TheDrox.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(TheDrox.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(TheDrox.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(TheDrox.."ttpppi",msg.sender.user_id)
Redis:setex(TheDrox.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(TheDrox.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(TheDrox.."zrfffidtf",msg.sender.user_id)
Redis:setex(TheDrox.."polic" .. msg.sender.user_id,300, true)
...
if Redis:sismember(TheDrox.."noooybgy",msg.sender.user_id) then
if Redis:get(TheDrox.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(TheDrox.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(TheDrox.."Drox:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheDrox.."Drox:Game:Riddles"..msg.chat_id,name)
...
Redis:set(TheDrox.."Drox:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(TheDrox.."Drox:Status:Games"..msg.chat_id) then
Redis:del(TheDrox.."Set:Country"..msg.chat_id)
...
Redis:set(TheDrox.."Game:Countrygof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheDrox.."Drox:Status:Games"..msg.chat_id) then
Redis:del(TheDrox.."Drox:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheDrox.."Drox:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheDrox.."Drox:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheDrox.."Drox:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheDrox.."Drox:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheDrox.."Drox:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheDrox.."Drox:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheDrox.."Drox:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:srem(TheDrox.."Drox:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheDrox..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheDrox.."Drox:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheDrox.."Drox:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheDrox.."Drox:Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheDrox then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheDrox..'Drox:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheDrox.."Drox:Lock:edit"..data.chat_id) then
...
local Get_Chat = LuaTele.getChat(ChatId)
local GetLink = Redis:get(TheDrox.."Drox:Group:Link"..ChatId) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{
...
io.popen("curl -s 'http://185.185.127.158/Drox/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=ogg&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Drox/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp3&msg=0'")
end
end
...
if tonumber(listYt[1]) == tonumber(IdUser) then
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
io.popen("curl -s 'http://185.185.127.158/Drox/yt2.php?url="..listYt[2].."&token="..Token.."&chat="..ChatId.."&type=mp4&msg=0'")
end
end
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/shaarDrox/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
...
{
{text = '𝖲𝗈𝗎𝗋𝖼𝖾 ‹ Mac:',url="t.me/DroxTeAm"}
},
}
local msg_id = Msg_id/2097152/0.5
...
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'ا','ايدي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'م','رفع مميز')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'اد', 'رفع ادمن')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'مد','رفع مدير')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'من', 'رفع منشئ')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'مط','رفع مطور')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'تك','تنزيل الكل')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'ر','الرابط')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'رر','ردود المدير')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'،،','مسح المكتومين')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'رد','اضف رد')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'سح','مسح سحكاتي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'غ','غنيلي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'رس','رسائلي')
Redis:set(TheDrox.."Drox:Get:Reides:Commands:Group"..UserId[2]..":"..'ثانوي','رفع مطور ثانوي')
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheDrox.."Drox:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheDrox.."Drox:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheDrox.."Drox:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheDrox.."Drox1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheDrox.."Drox:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheDrox.."Drox:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheDrox.."Drox:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheDrox.."Drox1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheDrox.."Drox:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheDrox.."Drox:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"‹ : ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheDrox.."Drox:Num:Add:Games"..ChatId..IdUser, 1)  
...
data = {
{
{text = '‹ : العاب السورس ', data = IdUser..'/normgm'}, {text = '‹ : الالعاب المتطوره', data = IdUser..'/degm'}, 
},
{
...
data = {
{
{text = '‹ : الالعاب المتطوره', data = IdUser..'/degm'}, 
},
{
{text = '- 𝖣𝖱𝗈𝗑 𝖳𝖾𝖺𝗆 .', url = 't.me/DroxTeAm'}, 
},
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheDrox.."Drox:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheDrox.."Drox:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheDrox.."Drox:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheDrox.."Drox:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheDrox.."Drox:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheDrox.."Drox:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheDrox.."Drox:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheDrox.."Drox:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheDrox..'Drox:'..lock..UserId[2],"del")    
end
...
local bank_users = Redis:smembers(TheDrox.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(TheDrox.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(TheDrox..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(TheDrox.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(TheDrox.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(TheDrox.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(TheDrox.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheDrox.."Drox:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."wtka:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."klb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."mar:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."smb:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."kholat:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."8by:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."3ra:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheDrox.."Drox:BanGroup:Group"..ChatId) 
